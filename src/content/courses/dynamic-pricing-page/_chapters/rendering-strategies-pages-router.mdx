...
```tsx title="src/components/PricingCard.tsx" {1-28}
...
```tsx title="src/components/PricingSection.tsx" {1-31}
...
```tsx title="src/pages/pages-router/ssr.tsx" {1-10}
...
```tsx title="src/pages/pages-router/ssr.tsx" {1,4-7}
...
```tsx title="src/pages/pages-router/ssr.tsx" {4-19}
import { GetServerSideProps } from 'next';
import PricingSection from '@/components/PricingSection';
...
```tsx title="src/components/PricingSection.tsx" {3-5, 7, 14, 24}
import PricingCard from './PricingCard';
...
```tsx title="src/pages/pages-router/ssr.tsx" {3, 7}
// Ommited for brevity
...
```ansi frame="none" showLineNumbers=false {13, 20}
...
<Callout>
	...
	Page"](/system-design/dynamic-pricing-page/overview) system design for a
	better understanding of these rendering strategies and how they would impact
	the user experience.
</Callout>
...
```tsx title="src/pages/pages-router/[country].tsx" {1-33}
import PricingSection from '@/components/PricingSection';
...
```ansi frame="none" showLineNumbers=false
# SOME OUTPUT OMMITTED FOR BREVITY
...
```ts title="src/middleware.ts" {1-17}
...
```ansi frame="none" showLineNumbers=false {14}
# SOME OUTPUT OMMITTED FOR BREVITY
...
```tsx title="src/pages/pages-router/csr.tsx" {1-37}
...
```ansi frame="none" showLineNumbers=false {8, 17}
# SOME OUTPUT OMMITTED FOR BREVITY
