...
```tsx title="./src/TaskList.tsx" {1-15}
...
```tsx title="./src/TaskListItem.tsx" {1-15}
...
```tsx title="./src/TaskList.tsx" {2, 10}
// Rest of the code omitted for brevity
...
```tsx title="./src/TaskListItem.tsx" {1-3}
...
```tsx title="./src/TaskList.tsx" {1-3}
...
```tsx title="./src/TaskListHeader.tsx" {1-7}
...
```tsx title="./src/TaskList.tsx" {1, 9-19, 24}
...
```tsx title="./src/TaskListItem.tsx" {2}
export default function TaskListItem({ children }: React.PropsWithChildren) {
