...
```tsx title="src/components/CodeEditor/CodeEditor.tsx" {1-3}
export default function CodeEditor() {
	return <div className='h-full border bg-red-100'>Code Editor</div>;
}
```

```tsx title="src/components/CodeEditor/index.ts" {1-3}
export * from './CodeEditor';

export { default } from './CodeEditor';
```

```tsx title="src/App.tsx" {2, 11}
...
```tsx title="src/components/CodeEditor/CodeEditor.tsx" {1, 5, 6}
...
```ts title="src/templates/react-vite.ts" {1-83}
type CodeFile = {
	contents: string;
};
...
```tsx title="src/components/CodeEditor/CodeEditor.tsx" {3, 6-8, 10, 16-17}
...
```tsx title="src/components/CodeEditor/CodeEditor.tsx" {15-25}
import React from 'react';
import { Editor } from '@monaco-editor/react';
import { VITE_REACT_TEMPLATE } from '../../templates/react-vite';
...
```tsx title="src/components/CodeEditor/FileTabs.tsx" {1-27}
type FileTabsProps = {
	activeFile: string;
...
```tsx title="src/components/CodeEditor/CodeEditor.tsx" {4, 15-19}
import React from 'react';
import { Editor } from '@monaco-editor/react';
import { VITE_REACT_TEMPLATE } from '../../templates/react-vite';
...
```ts title="src/utils/classNames.ts" {1-6}
...
```tsx title="src/components/CodeEditor/FileTabs.tsx" {1, 19-22}
...
```ts title="src/components/CodeEditor/getLanguageFromFileName.ts" {1-17}
...
```tsx title="src/components/CodeEditor/CodeEditor.tsx" {5, 13, 26}
import React from 'react';
import { Editor } from '@monaco-editor/react';
import { VITE_REACT_TEMPLATE } from '../../templates/react-vite';
import FileTabs from './FileTabs';
