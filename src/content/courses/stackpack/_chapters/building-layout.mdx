...
npm install react-resizable-panels@2.0.16
```

Update our `src/App.tsx` file to structure our layout quickly.

```tsx title="src/App.tsx" {1-23}
...
```tsx title="src/App.tsx" {5, 10, 14, 20, 23}
import { Panel, PanelGroup, PanelResizeHandle } from 'react-resizable-panels';
...
```tsx title="src/App.tsx" {10, 14, 20}
import { Panel, PanelGroup, PanelResizeHandle } from 'react-resizable-panels';
...
At this point, our code should match the code in the branch [`2-layout`](https://github.com/Frontend-Hire/stackpack-webcontainers-react-typescript/tree/2-layout).
