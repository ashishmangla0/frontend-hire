...
```tsx title="src/providers/WebContainerProvider/WebContainerProvider.tsx" {1-53}
...
```tsx title="src/providers/WebContainerProvider/useWebContainer.tsx" {1-13}
import React from 'react';
...
```tsx title="src/providers/WebContainerProvider/index.ts" {1-3}
...
```ts title="src/templates/react-vite.ts" {1-91}
...
```tsx title="src/components/CodeEditor/CodeEditor.tsx" {5-6, 9-10, 12,  18, 25}
import React from 'react';
