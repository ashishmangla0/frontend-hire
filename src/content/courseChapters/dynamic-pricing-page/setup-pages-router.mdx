...
```tsx title="src/pages/pages-router/ssr.tsx" {1-3}
...
```css title="src/styles/globals.css" {1-3}
@tailwind base;
@tailwind components;
@tailwind utilities;
```
...
```tsx title="src/app/layout.tsx" {3}
...
```tsx title="src/pages/_app.tsx" {1-6}
import '@/styles/globals.css';
...
```tsx title="src/pages/_document.tsx" {1-13}
