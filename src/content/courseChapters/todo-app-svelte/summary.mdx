...
Our goal was to teach you how to build a Svelte application while learning some of the best practices in Svelte and using TypeScript without much hassle. We also saw how TDD can help us write more confident code.
...
Also, you could try this exact course in React: [Todo App | Frontend Hire](/courses/todo-app-react/overview)
