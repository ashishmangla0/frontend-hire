...
```ts title="src/routes/page.test.ts" {6, 8, 10}
...
```ts title="src/routes/page.test.ts" {6-19}
// Rest of the code omitted for brevity
...
```svelte title="src/routes/+page.svelte" {11}
<script lang="ts">
...
```svelte title="src/routes/+page.svelte" {9}
<!-- Rest of the code omitted for brevity  -->
...
```svelte title="src/routes/+page.svelte" {4-6,12}
<script lang="ts">
  // Some of the code is omitted for brevity
