...
```tsx title="./src/TaskInput.tsx" {1-13}
...
```tsx title="./src/TaskInput.tsx" {1-5, 7-11}
type TaskInputProps = {
	taskName: string;
...
```tsx title="./src/TaskInput.tsx" {5, 12, 23}
type TaskInputProps = {
	taskName: string;
	setTaskName: (taskName: string) => void;
	onInputKeyDown: (e: React.KeyboardEvent<HTMLInputElement>) => void;
...
```tsx title="./src/AddTask.tsx" {1, 5, 10}
type AddTaskProps = {
	// Some of the code omitted for brevity
};
...
```tsx title="./src/AddTask.tsx" {1-5, 7-16}
type AddTaskProps = {
	taskName: string;
	setTaskName: (taskName: string) => void;
	onAddTask: () => void;
...
```tsx title="./src/AddTask.tsx" {1, 3-5, 7-8, 12, 25}
import React from 'react';
...
```tsx title="./src/AddTask.tsx" {10, 30}
import React from 'react';
import { Task } from './types';
import AddTask from './AddTask';
...
```tsx title="./src/AddTask.tsx" {10-19, 23, 36}
import React from 'react';
...
```tsx title="./src/AddTask.tsx" {18, 20-24, 26}
// Rest of the code omitted for brevity
...
```tsx title="./src/AddTask.tsx" {6-7, 19, 22, 27}
// Rest of the code omitted for brevity
