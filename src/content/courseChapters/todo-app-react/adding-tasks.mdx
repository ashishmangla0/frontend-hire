...
```tsx title="./src/App.tsx" showLineNumbers=false {5, 6}
...
```tsx title="./src/App.tsx" showLineNumbers=false {7-13}
// Rest of the code omitted for brevity
...
```tsx title="./src/App.tsx" showLineNumbers=false {1, 8, 16-17}
...
```tsx title="./src/App.tsx" showLineNumbers=false {5}
// Rest of the code omitted for brevity
...
```tsx title="./src/App.tsx" showLineNumbers=false {4-11}
// Rest of the code omitted for brevity
...
```tsx title="./src/App.tsx" showLineNumbers=false {5-11}
// Rest of the code omitted for brevity
...
```tsx title="./src/App.tsx" showLineNumbers=false {8-17, 23}
// Rest of the code omitted for brevity
