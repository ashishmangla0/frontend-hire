...
```tsx title="./src/App.test.tsx" {1-5}
...
```tsx title="./src/App.test.tsx" {9-10}
...
```tsx title="./src/App.test.tsx" {12-13}
import { describe, expect, test } from 'vitest';
import { render, screen } from '@testing-library/react';
import App from './App';
...
```tsx title="./src/App.test.tsx" {3,12-13}
import { describe, expect, test } from 'vitest';
import { render, screen } from '@testing-library/react';
...
```ts title="./setupTests.ts" {1}
import '@testing-library/jest-dom/vitest';
```

And remove the import from the test file.

```tsx title="./src/App.test.tsx" {3}
import { describe, expect, test } from 'vitest';
import { render, screen } from '@testing-library/react';
...
```tsx title="./src/App.test.tsx" {2, 17-23}
import { describe, expect, test } from 'vitest';
...
```tsx title="./src/App.test.tsx" {2-3, 18, 24-25, 27-29}
import { describe, expect, test } from 'vitest';
