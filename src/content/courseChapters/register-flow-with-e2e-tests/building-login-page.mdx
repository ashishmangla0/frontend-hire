---
courseId: register-flow-with-e2e-tests
...
```tsx title="src/app/(auth)/login/page.tsx" {1-20}
...
```tsx title="src/app/(auth)/login/page.tsx" {17-22}
import Link from 'next/link';
...
```ts title="src/app/(auth)/login/_actions/login.ts" {1-3}
'use server';
...
```ts title="src/app/(auth)/login/_actions/login.ts" {3-5}
'use server';
...
```tsx title="src/app/(auth)/login/page.tsx" {2, 8}
import Link from 'next/link';
...
```tsx title="src/app/(auth)/login/page.tsx" {11, 15}
import Link from 'next/link';
import { login } from './_actions/login';
...
```ts title="src/app/(auth)/login/_actions/login.ts" {3, 5-8, 11-21}
'use server';
...
```tsx title="src/app/(auth)/login/page.tsx" {1, 3, 8, 13, 17, 22}
'use client';
...
```ts title="src/app/(auth)/login/_actions/login.ts" {10}
'use server';
...
```ts title="src/app/(auth)/login/_actions/login.ts" {3, 24-35}
'use server';
...
```ts title="src/app/(auth)/login/_actions/login.ts" {4, 38}
'use server';
...
```tsx title="src/app/(protected)/layout.tsx" {1-3}
...
```tsx title="src/app/(protected)/dashboard/page.tsx" {1-8}
...
```tsx title="src/app/(protected)/layout.tsx" {1-19}
import { createClient } from '@/utils/supabase/server';
import { redirect } from 'next/navigation';
...
```tsx title="src/components/LogOutButton.tsx" {1-23}
'use client';
