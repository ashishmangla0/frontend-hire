...
```tsx title='src/app/(marketing)/page.tsx' {9-18}
import Link from 'next/link';
...
```tsx title='src/app/(marketing)/page.tsx' {1-2,7,14}
...
```tsx title='src/app/(marketing)/about/page.tsx' {1-2,6-9,12-14}
import Footer from '../_components/footer';
import Header from '../_components/header';
...
```tsx title='src/app/(marketing)/page.tsx' {1-8}
export default function Home() {
	return (
		<section className='container mx-auto p-4'>
			<h1 className='text-3xl font-bold'>Welcome to our website</h1>
...
```tsx title='src/app/(marketing)/about/page.tsx' {1-8}
export default function About() {
	return (
		<section className='container mx-auto p-4'>
			<h1 className='text-3xl font-bold'>About Us</h1>
...
```ts title="tailwind.config.ts" {11-14}
...
```tsx title='src/app/(marketing)/_components/header.tsx' {6}
import Link from 'next/link';
...
```tsx title='src/app/(marketing)/_components/footer.tsx' {3}
export default function Footer() {
	return (
...
```tsx title='src/app/(marketing)/page.tsx' {3}
export default function Home() {
	return (
...
```tsx title='src/app/(marketing)/about/page.tsx' {3}
export default function About() {
	return (
		<section className='container py-2'>
			<h1 className='text-3xl font-bold'>About Us</h1>
