...
<Callout>
	We also have [a corresponding course](/courses/dynamic-pricing-page/overview)
	where we implement a decent solution. Though, we would suggest you read this
	system design guide first.
</Callout>
