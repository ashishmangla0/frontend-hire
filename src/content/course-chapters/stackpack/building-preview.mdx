...
```tsx title="src/components/Preview/Preview.tsx" {1-3}
...
```tsx title="src/components/Preview/index.ts" {1-3}
export * from './Preview';
...
```tsx title="src/components/Preview/Preview.tsx" {4, 7-11}
...
```tsx title="src/components/CodeEditor/CodeEditor.tsx" {9, 15-19, 31}
import React from 'react';
