...
```tsx title="src/components/Terminal/Terminal.tsx" {1-3}
export default function Terminal() {
	return <div className='h-full border bg-red-100'>Terminal</div>;
}
```

```tsx title="src/components/Terminal/index.ts" {1-3}
...
```tsx title="src/components/Terminal/Terminal.tsx" {1-23}
...
```tsx title="src/components/Terminal/Terminal.tsx" {3, 14, 16, 18}
import React from 'react';
import { Terminal as XTerminal } from '@xterm/xterm';
...
```tsx title="src/components/Terminal/Terminal.tsx" {12-24}
import React from 'react';
import { Terminal as XTerminal } from '@xterm/xterm';
import { FitAddon } from 'xterm-addon-fit';
import '@xterm/xterm/css/xterm.css';
...
```tsx title="src/components/Terminal/Terminal.tsx" {11, 15-17, 32}
import React from 'react';
import { Terminal as XTerminal } from '@xterm/xterm';
import { FitAddon } from 'xterm-addon-fit';
import '@xterm/xterm/css/xterm.css';
...
```tsx title="src/components/Terminal/Terminal.tsx" {4, 13-19, 68}
import React from 'react';
import { Terminal as XTerminal } from '@xterm/xterm';
import { FitAddon } from 'xterm-addon-fit';
