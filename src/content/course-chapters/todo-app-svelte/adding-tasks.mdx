...
```svelte title="src/routes/+page.svelte" {5, 6}
...
```svelte title="src/routes/+page.svelte" {7}
<!-- Rest of the code omitted for brevity  -->
...
```svelte title="src/routes/+page.svelte" {4, 10}
<script lang="ts">
...
```svelte title="src/routes/+page.svelte" {6, 7}
<!-- Rest of the code omitted for brevity  -->
...
```svelte title="src/routes/+page.svelte" {4}
<script lang="ts">
  // Some of the code omitted for brevity
...
```svelte title="src/routes/+page.svelte" {6-11}
<!-- Rest of the code omitted for brevity  -->
...
```svelte title="src/routes/+page.svelte" {6-13}
<!-- Rest of the code omitted for brevity  -->
...
```svelte title="src/routes/+page.svelte" {22-27,34}
<script lang="ts">
