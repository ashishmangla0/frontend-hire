...
```ts title="src/routes/page.test.ts" {1-5}
...
```ts title="src/routes/page.test.ts" {2,4,8}
import { describe, test } from 'vitest';
...
```ts title="src/routes/page.test.ts" {2,10-11}
import { describe, test } from 'vitest';
...
```ts title="src/routes/page.test.ts" {1,13-14}
...
```ts title="src/routes/page.test.ts" {3,14-15}
import { describe, test, expect } from 'vitest';
import { render, screen } from '@testing-library/svelte';
...
```ts title="./src/tests/setup-tests.ts" {1}
import '@testing-library/jest-dom/vitest';
```
...
```ts title="src/routes/page.test.ts" {17}
import { describe, test, expect } from 'vitest';
import { render, screen } from '@testing-library/svelte';
...
```ts title="src/routes/page.test.ts" {2, 17-27}
import { describe, test, expect } from 'vitest';
...
```svelte title="src/routes/+page.svelte" {6}
...
```ts title="src/routes/page.test.ts" {2-3,19,25-26,28-30}
import { describe, test, expect } from 'vitest';
